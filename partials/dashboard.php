...
<body class="bg-secondary text-light">
    <div class="container my-5">
        ...
        <h1 class="my-5">Constitutional Signature Collection Website</h1>
        <div class="row my-5">
            <div class="col md-7">
                <?php
                 if(isset($_SESSION['groups'])){
                    ...
                    <div class="col md-8">
                        <strong class="text-dark h5">Name:</strong><?php echo $groups[$i]['username']; ?><br> <br>
                        <strong class="text-dark h5">Sigantures Collected:</strong><?php echo $groups[$i]['vote']; ?><br>
                    </div>
                </div>

                <form action="../actions/voting.php" method="post">
                    <input type="hidden" name="groupvotes" value="<?php echo $groups[$i]['vote']; ?>">
                    ...
                    if($_SESSION['status']==1){
                        ...
                        ?>
                        <button class="bg-danger my-3 text-white px-3" type="submit">Should Resign</button>
                        <?php
                    }
            ...
            <div class="col md-5">
                ...
                <br>
                <br>
                <strong class="text-dark h5">Citizen: </strong><?php echo $data['username'];?><br><br>
